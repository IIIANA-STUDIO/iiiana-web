...
export default function DevelopPopover() {
            ...
            >
                <Grid container style={{width: 400}}>
                    <Grid item lg={4} md={4} style={{paddingRight: 10,  paddingLeft:10}}>
                        <p style={{fontSize: "x-large", margin:0, color: "#6c6cf6",}}>Develop</p>
                            ...
                            <Grid container>
                                <Grid item lg={2} md={2} style={{position: "relative"}}>
                                    <div style={{
                                        ...
                                        <DescriptionIcon style={{width: "100%", height: "auto", color: "#FFF"}}/>
                                    </div>

                                </Grid>
                                <Grid item lg={10} md={10}>
                                    <p style={{marginBottom: "0px", fontWeight: 400, fontSize: "16px"}}>Docs</p>
                            ...
                            <Grid container>
                                <Grid item lg={2} md={2} style={{position: "relative"}}>
                                    <div style={{
                                        ...
                                        <LibraryAddIcon style={{width: "100%", height: "auto", color: "#FFF"}}/>
                                    </div>

                                </Grid>
                                <Grid item lg={10} md={10}>
                                    <p style={{marginBottom: "0px", fontWeight: 400, fontSize: "16px"}}>Integration</p>
                            ...
                            <Grid container>
                                <Grid item lg={2} md={2} style={{position: "relative"}}>
                                    <div style={{
                                        ...
                                        <SettingsIcon style={{width: "100%", height: "auto", color: "#FFF"}}/>
                                    </div>

                                </Grid>
                                <Grid item lg={10} md={10}>
                                    <p style={{marginBottom: "0px", fontWeight: 400, fontSize: "16px"}}>API References</p>
                                    <p style={{color: "#807875", fontSize: "13px"}}>Create and send link with ease.</p>
                                </Grid>
                            </Grid>
                        </a>
