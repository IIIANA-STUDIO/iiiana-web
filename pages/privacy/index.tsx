    ...
    return (
        <React.Fragment>
            <NavLayout>
                ...
                <section className="section bg-red" style={{paddingTop: "50px"}}>
                   ...
                   <div className="home-center" style={{padding : "0 100px", color: "#000"}}>
                    ...
                    <div className="home-center" style={{padding : "0 100px", color: "#000"}}>
                        <h2>User access of Personal Information
                        </h2>
                        <div style={{border: "2px solid #28a745",
                            width: 50}}>
                        </div>
                    ...
                    <div className="home-center" style={{padding : "0 100px", color: "#000"}}>
                        ...
                        <p style={{margin: "25px 0 0 0"}}>
                            Your account is password protected. We use industry standard measures to protect the Personal Information that is stored in our database. We limit the access to your Personal Information to those employees and contractors who need access to perform their job function, such as our customer service personnel. If you have any questions about the security on Razorpay, please contact us at
                            <a href="#">security@razorpay.com.</a>
                        </p>
                        <p style={{margin: "25px 0 0 0"}}>
                    ...
                    <div className="home-center" style={{padding : "0 100px", color: "#000"}}>
                        ...
                        <p style={{margin: "25px 0 0 0"}}>
                            If you do not wish to permit changes in our use of your Personal Information, you must notify us promptly that you wish to deactivate your account with us. Continued use of Razorpay after any change/ amendment to this Privacy Policy shall indicate your acknowledgement of such changes and agreement to be bound by the terms and conditions of such changes.
                        </p>
                        <p style={{margin: "25px 0 0 0"}}></p>
                    </div>
                    ...
                    <div className="home-center" style={{padding : "0 100px", color: "#000"}}>
                        <h2>Grievance cum Nodal Officer</h2>
                        <div style={{border: "2px solid #28a745",
                            width: 50}}>
                        </div>
                        <p style={{margin: "25px 0 0 0"}}>
